            ...
            <tbody>
                <?php foreach ($data->projektienYhteenveto as $projekti): ?>
                    <tr>  
                        ...
                        <td class="col-xs-1"><input type="checkbox" name="redirect" value="hallinnointi_henkilon_tiedot.php?id=<?php echo $data->henkilo->getHenkilo_id(); ?>&filter=<?php echo $projekti[0]; ?>#tiedot" 
                        ...
                        <td class="col-xs-2"><?php echo $projekti[3]; ?></td>
                        <td class="col-xs-3"><?php echo $projekti[4]; ?></td> 
                    </tr>
                <?php endforeach; ?>

                <!--kaikkien projektien yhteenveto, Array[0] = tunnit yhteensä, Array[1] = merkintöjen lkm-->
                <tr>
                    <td class="col-xs-1"><input type="checkbox" name="redirect" value="hallinnointi_henkilon_tiedot.php?id=<?php echo $data->henkilo->getHenkilo_id(); ?>#tiedot"<?php if (empty($data->filtteriProjekti)): ?> checked="checked"<?php endif; ?>></td>
                    <td class="col-xs-3"><strong>Kaikki projektit: <?php echo $data->projektiLkm; ?> kpl</strong></td>
                    <td class="col-xs-5"></td>
                    <td class="col-xs-2"><strong><?php echo $data->tunnitJaMerkinnat[0]; ?></strong></td>
                    <td class="col-xs-3"><strong><?php echo $data->tunnitJaMerkinnat[1]; ?></strong></td> 
                </tr>
